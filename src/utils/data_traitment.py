...
import pandas as pd
import pathlib
from utils.Fonctions import convert_to_numeric
...
global_df_brut = convert_to_numeric(pd.read_csv(RAW_DATA_PATH.joinpath("rawdata.csv"),delimiter=';',encoding='utf-8'))
