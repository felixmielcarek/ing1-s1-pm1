...
def pages_fonctions(type_mean,y,value,tab,exclure,choix,threshold,condition1,col,columns,choix_scinder,condition_colonne,comp_colonne):
    if dt.global_df_brut is not None and tab=='options':
        ...
        filename=''
        style4={'display':'block','height':'40px','width':'300px','backgroundColor': '#eeeeee', 'color': 'black','border':'none','borderRadius': '10px','textAlign': 'left','margin-left':'0%'}
        table={'border': '10px solid #fae5d3','width':'90%','margin-left':'8px','margin-left':'0px','position': 'absolute','top': '15%','zIndex': '100'}
           
        if  df is not None :
            if value is None:
                return None,{'display': 'none'},{'display': 'none'}, dash.no_update, {'display': 'none'}, dash.no_update,{'display':'none'},{'display':'none'},f"Nom : {filename}",style4,table,{'display':'none'},None,None, dash.no_update,{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},None,{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'},{'display':'none'},{'display': 'none'},{'display': 'none'},{'display': 'none'},{'display': 'none'},None,None,None,None,None,{'display': 'none'},{'display': 'none'},{'display': 'none'}, dash.no_update,{'display': 'none'},{'display':'none'},{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'},None,None,{'display': 'none'},None,None,None,{'display':'none'}
            match value :
                case 'filtrage_df_données':
                    ...
                    return None,{'display': 'none'},{'display': 'none'}, dash.no_update, {'display': 'none'},opt_columns,aff1,{'display': 'inline-block','margin':'auto'},f"Nom du fichier : {filename}",style4,table,{'display':'none'},None,None,options,{'display':'block','height':'40px','width':'300px','backgroundColor': '#eeeeee', 'color': 'black','border':'none','borderRadius': '10px','textAlign': 'left','margin-left':'0%'},{'display': 'inline-block'},{'display': 'inline-block','backgroundColor':couleur_btnbackground, 'color': couleur_text,'border': '2px solid #4b5160'},{'margin-bottom': '100px','display': 'inline-block','width':'65%','vertical-align': 'top','margin':'auto'},{'display':'inline-block'},{'display':'inline-block'},{'margin-bottom': '100px','display': 'inline-block','width':'65%','vertical-align': 'top','margin':'auto'},{'margin-bottom': '100px','display': 'inline-block','width':'65%','vertical-align': 'top','margin':'auto'},{'display':'none'},{'display':'none'},None,{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'},options,{'display': 'inline-block','width':'80%','vertical-align': 'top','margin-left':'0px','backgroundColor': couleur_drpbackground, 'color': couleur_text,'border':'none','borderRadius': '10px'},{'display':'inline-block'}, dash.no_update,{'display':'none'},{'display':'none'},{'display':'none'},{'display': 'none'},{'width':'100%','padding-left': '0px','heigh':'100px','padding-top': '0px','border': '2px solid #1e2130','display':'flex'},{'width':'100%','padding-left': '0px','heigh':'100px','padding-top': '0px','border': '2px solid #1e2130','display':'flex'},{'width':'100%','padding-left': '0px','heigh':'100px','padding-top': '0px','border': '2px solid #1e2130','display':'flex'},msg_comp,msg_cond_comp,None,msg_filt_seuil,saut_comp,{'display': 'none'},{'display': 'none'},{'display': 'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'}, dash.no_update,{'display':'none'}, {'display': 'none'},'Filtrage par valeur seuil','Filtrage par colonne', show_df,html.Div([html.Br(),html.Br(),html.Div('Exclusion de colonne(s)')]),html.Br(),'Veuillez choisir où vous allez stocker vos données.',{'display': 'none'}
               
                case 'moyenne':
                    opt_colonnes=[{'label': i, 'value': i} for i in df.columns]
                    #df.groupby('CRIT_AIR')['PARC_2024'].transform('mean')
                    return None,{'display': 'none'},{'display': 'inline-block','margin':'auto','backgroundColor':couleur_btnbackground, 'color': couleur_text,'border': '2px solid #4b5160'},opt_colonnes,{'display': 'inline-block','width':'80%','vertical-align': 'top','margin':'auto','backgroundColor': couleur_drpbackground, 'color': couleur_text,'border':'none','borderRadius': '10px'}, dash.no_update,{'display':'none'},{'display':'none'},f"Nom du fichier : {filename}",style4,table,{'display':'none'},None,None, dash.no_update,{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'} ,{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},None,{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'},{'display':'none'},{'display': 'none'},{'display': 'none'},{'display': 'none'},{'display': 'none'},None,None,None,None,None,{'display': 'none'},{'display': 'none'},{'display': 'none'}, dash.no_update,{'display': 'none'},{'display':'none'},{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'},None,None,{'display': 'none'},None,None,None,{'display': 'inline-block'}# Add ,{'display': 'none'}
                case 'rename':
                    ...
                    return None,{'display': 'none'},{'display': 'none'}, dash.no_update, {'display': 'none'}, dash.no_update,{'display':'none'},{'display':'none'},f"Nom du fichier : {filename}",style4,table,{'display':'none'},None,None, dash.no_update,{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},None,style_rename,opt_colonnes_rename,style_rename_buton,{'display': 'inline-block','margin':'auto','width':'60%'}, dash.no_update,{'display':'none'},{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'},{'display':'none'},{'display': 'none'},{'display': 'none'},{'display': 'none'},{'display': 'none'},None,None,None,None,None,{'display': 'none'},{'display': 'none'},{'display': 'none'}, dash.no_update,{'display': 'none'},{'display':'none'}, dash.no_update, dash.no_update,{'display':'none'},{'display':'none'},None,None,{'display': 'none'},None,None,None,{'display': 'none'}
                case 'scission':
                ...
                case 'fichier':
                    ...
                    return None,{'display': 'none'},{'display': 'none'}, dash.no_update, {'display': 'none'}, dash.no_update,{'display':'none'},style12,f"Nom du fichier : {filename}",style4,table,{'display':'none'},None,None, dash.no_update,{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},None,{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'},{'display':'none'},{'display': 'none'},{'display': 'none'},{'display': 'none'},{'display': 'none'},None,None,None,None,None,{'display': 'none'},{'display': 'none'},{'display': 'none'}, dash.no_update,{'display': 'none'},{'display':'none'}, dash.no_update, dash.no_update,{'display':'none'},{'display':'none'},None,None,{'display': 'none'},None,None,None,{'display': 'none'}
                case 'solveur':
                    ...
                    return None,{'display':'none'},{'display':'none'}, dash.no_update,{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'},f"Nom du fichier : {filename}",style4,table,{'display': 'none'},None,None, dash.no_update,{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},None,{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'},opt_solveur,dropsolv,style_formule,style_formule_buton,{'display':'inline-block'},{'display': 'none'},{'display': 'none'},{'display': 'none'},None,None,None,None,None,{'display': 'none'},{'display': 'none'},{'display': 'none'}, dash.no_update,{'display': 'none'},{'display':'none'},{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'},None,None,{'display': 'none'},None,None,None,{'display': 'none'}
                case 'calcul_pente':
                    ...
                    return None,{'display': 'none'},{'display': 'none'}, dash.no_update, {'display': 'none'}, dash.no_update,{'display':'none'},{'display':'none'},f"Nom du fichier : {filename}",style4,table,{'display':'none'},None,None, dash.no_update,{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},None,{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'},{'display':'none'},{'display': 'none'},{'display': 'none'},{'display': 'none'},{'display': 'none'},None,None,None,None,None,{'display': 'none'},{'display': 'none'},{'display': 'none'}, dash.no_update,{'display': 'none'},{'display':'none'},drop_pente,opt_colonnes_pente,{'display':'inline-block'},style_pente_button,None,None,{'display': 'none'},None,None,None,{'display': 'none'}
                case 'prof':
                    #Il y 0 elements qui sont liées a prof donc a voir
                    return None,{'display':'none'},{'display':'none'}, dash.no_update,{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'},f"Nom du fichier : {filename}",style4,table,{'display': 'none'},None,None, dash.no_update,{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},None,{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'},{'display':'none'},{'display': 'none'},{'display': 'none'},{'display': 'none'},{'display': 'none'},None,None,None,None,None,{'display': 'none'},{'display': 'none'},{'display': 'none'}, dash.no_update,{'display': 'none'},{'display':'none'},{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'},None,None,{'display': 'none'},None,None,None,{'display': 'none'}
                case 'fusion_fichier':
                    return None,{'display': 'none'},{'display': 'none'}, dash.no_update, {'display': 'none'}, dash.no_update,{'display':'none'},{'display':'none'},f"Nom du fichier : {filename}",style4,table,{'display':'none'},None,None, dash.no_update,{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'inline-block'},{'display':'inline-block'},None,{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'},{'display':'none'},{'display': 'none'},{'display': 'none'},{'display': 'none'},{'display': 'none'},None,None,None,None,None,{'display': 'none'},{'display': 'none'},{'display': 'none'}, dash.no_update,{'display': 'none'},{'display':'none'},{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'},None,None,{'display': 'none'},None,None,None,{'display': 'none'}
    else:
        return None,{'display': 'none'},{'display': 'none'}, dash.no_update, {'display': 'none'}, dash.no_update,{'display':'none'},{'display':'none'},dash.no_update,{'display':'none'},{'display':'none'},{'display':'none'},None,None, dash.no_update,{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},{'display':'none'},None,{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'},{'display':'none'},{'display': 'none'},{'display': 'none'},{'display': 'none'},{'display': 'none'},None,None,None,None,None,{'display': 'none'},{'display': 'none'},{'display': 'none'}, dash.no_update,{'display': 'none'},{'display':'none'},{'display':'none'}, dash.no_update,{'display':'none'},{'display':'none'},None,None,{'display': 'none'},None,None,None,{'display': 'none'}
...
def fcnt_Filtrage_des_Données(filtre,tab,choix,submit,choix_newdf, col, condition2, condition3, threshold2, threshold3, threshold1, condition1, comp_colonne, condition_colonne,col_filtrage_données):
    ctx = dash.callback_context
    if not ctx.triggered:
        button_id = 'No clicks yet'
    else:
    ...
    if (button_id=='submit' and choix_newdf is not None):
        ...
        df=choix_df(choix,dt.global_df_brut,dt.global_df_mean,dt.global_df_fusionnées,dt.global_meandf_fusionnées,dt.global_df_1,dt.global_df_2,dt.global_df_3,dt.global_df_4,dt.global_df_5,dt.global_meandf_1,dt.global_meandf_2,dt.global_meandf_3,dt.global_meandf_4,dt.global_meandf_5)
        oldf=df.copy()
        if (col_filtrage_données is not None and (condition2 or condition3 or threshold2 or threshold3 or threshold1 or condition1)) or (comp_colonne is not None and condition_colonne is not None):
            print("\n\n\n\n ALOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO\n\n\n\n",col_filtrage_données,"\n voici la valeur \n",condition1,"\n\n le threshold\n",threshold1)
            df=apply_filters(df, col_filtrage_données, [condition1, condition2, condition3], [threshold1, threshold2, threshold3], condition_colonne, comp_colonne)
